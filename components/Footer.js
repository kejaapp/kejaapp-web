...
export default function Footer(){
    ...
    return(
        <Flex direction='column' mt='20px'>
            ...
            <Center m='10px'>
                <Flex gap='3'>
                <a href="https://www.instagram.com/keja_app/" target="_blank" rel="noopener noreferrer" style={{color:'#212222'}}><Instagram /></a>
                <a href="https://twitter.com/Keja_app" target="_blank" rel="noopener noreferrer" style={{color:'#212222'}}><Twitter /></a>
                </Flex>
            </Center>
            <Center>
                <Flex gap='2' >
