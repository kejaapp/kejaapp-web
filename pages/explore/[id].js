            ...
            <Center>
                <Flex flexWrap='wrap' justify={'space-around'}>
                    ...
                    <Flex align='center' justify='center' direction='column' mt='20%'>
                        <Text fontFamily='Poppins-bold' w='80%'>We could not find the apartments you are looking for. Contact us by whatsapp @ <a href="https://wa.me/0771712005" target="_blank" style={{color:"#ffa31a",fontFamily:"Poppins-bold"}}>0771712005</a> or call us at <a href='tel:0771712005' target="_blank" style={{color:"#ffa31a",fontFamily:"Poppins-bold"}}>0771712005</a> so that we can assist you.</Text>
